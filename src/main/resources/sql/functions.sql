...
CREATE OR REPLACE FUNCTION contact_list(var_user_login VARCHAR, var_ip VARCHAR) RETURNS SETOF contact_type AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION group_list(var_user_login VARCHAR, var_ip VARCHAR) RETURNS SETOF group_type AS $$
DECLARE
